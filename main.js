...
function Up(){
    if(player_y>=0){// ensures the player does not escape the boundaries
    ...
    function Down(){
        if(player_y<=500){// ensures the player does not escape the boundaries
        player_y=player_y+block_image_height;
        console.log("block image height="+block_image_height);
        ...
        function Left(){
            if(player_x>0){// ensures the player does not escape the boundaries
            ...
            function Right(){
                if(player_x<=850){// ensures the player does not escape the boundaries
                player_x=player_x+block_image_width;
                console.log("block image height="+block_image_height);
